...
function displayPics(){
  ...
  // ANSWER: the variable rando needs to be reassigned and let will not allow that to happen.  Let is more restrictive when used with a varaible. Var allows the variable to be reassigned.
