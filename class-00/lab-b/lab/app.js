...
let sumAndProduct = (a, b) => `${a + b} ${a * b}`;  // TODO: can't get the '2' to show up??  .map?
//   sum = (a + b);
//   let product = a * b;
//   return [sum, product];
// });
...
// Student.prototype.greeting = () => `Hi, my name is ${name}`
...
// 1. What is "this" when joe.scope() is invoked?   https://www.youtube.com/watch?v=GhbhD1HR5vk&t=116s
//undefined - due to 'this' is not a global varable
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// it's calling the window object instead of 'this'
//
// 3. Explain why "this" is different when an arrow function is used.
//
//  The arrow function doesn't BIND the object 'this'.  
